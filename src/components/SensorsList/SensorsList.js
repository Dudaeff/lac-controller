...
import { ComponentsCard, ComponentsTitle,ComponentsList } from "components/ComponentListItem/ComponentsListItem.styled";
                        ...
                        <ComponentsCard>
                            ...
                            <ComponentsList>
                                {sensor.Components.map(component => {
                                    return (
                                        <ComponentsListItem key={nanoid()} component={component} />
                                    )
                                })}
                            </ComponentsList>
                        </ComponentsCard>
